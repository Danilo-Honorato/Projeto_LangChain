...
def process_pdf(file):
    with tempfile.NamedTemporaryFile(delete=False, suffix='.pdf') as temp_file:
        temp_file.write(file.read()) #Salvar o arquivo em disco do binário
...
with st.sidebar:
    ...
    st.sidebar.markdown('')
    st.sidebar.markdown('')
    st.sidebar.markdown('Obs.: Ao carregar o arquivo ele fica dísponivel em nosso banco de dados.')
